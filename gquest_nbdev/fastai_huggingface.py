...
__all__ = ['seed_all', 'MODEL_CLASSES', 'TransformersBaseTokenizer', 'Tokenizer_MultiColumn', 'TransformersVocab',
           'SortSampler_Stateful', 'SortishSampler_Stateful', 'TokenizeProcessorDualBert', 'TabularDataBunch_Sample',
           'TabularList_Sample', 'ExactSampler', 'no_collate', 'TextClasDataBunch_Multi', 'TextList_Multi',
           'MixedObjectDataBunch', 'MixedObjectLists', 'MixedObjectList', 'LabelList_Multi', 'LabelLists_Multi',
           'TabularModel_NoCat', 'CustomTransformerModel', 'AvgSpearman', 'AvgSpearman2', 'AddExtraBunch',
...
# Cell
class SortSampler_Stateful(SortSampler):
    def __iter__(self):
        self.current_idxs=sorted(range_of(self.data_source), key=self.key, reverse=True)
        return iter(self.current_idxs)
...
class TextClasDataBunch_Multi(TextDataBunch):
    ...
    def create(cls, train_ds, valid_ds, test_ds=None, path:PathOrStr='.', bs:int=32, val_bs:int=None, pad_idx=1,
        ...
        for ds in datasets[1:]:
            ...
            sampler = SortSampler_Stateful(ds.x, key=lengths.__getitem__)
